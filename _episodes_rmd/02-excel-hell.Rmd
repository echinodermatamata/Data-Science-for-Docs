...
teaching: 50
exercises: 10
questions: What is the place of a spreadsheet programme?
objectives:
...
The accompanying slides for this lesson are available [here](/assets/teaching_materials/slides/02-slides-excel-hell.html). 

You might also enjoy checking out _[janitor](http://sfirke.github.io/janitor/)_: a nice R library that tries to fix automatically what we teach below. Or consider trying [OpenRefine](http://openrefine.org) which even has an supporting [data carpentry lesson](https://datacarpentry.org/OpenRefine-ecology-lesson/00-getting-started/).
...
> ## Challenge: This is hard: what's the difference? And why?
>
...
> > ~~~
> > {: .output}
> > The answer is (confusingly) `TRUE` (good > best) because unless you explicitly provide the factor levels then R will sort them alphabetically. You need to adjust the code like this instead.
> >
> > ~~~
> > ordinals <- factor(c('Good', 'Best', 'Good'),
> >     levels=c("Good", "Better", "Best"), ordered=TRUE)
